...
<table class="form-table" id="ipt_fsqm_intg_cm_full_wrap">
	...
	protected function integration_custommeta( $op, $name_prefix, $help = '', $parameters_list = [] ) {
		...
		$items[] = [
			...
			'help' => __( 'If you want to send additional metadata to every this integrations then activate it.', 'ipt_fsqm' ),
			'description' =>
				$help !== ''
					? sprintf(
		...
		<tr>
			...
			<td>
				<?php $this->ui->toggle( 'settings[integration][formhandler][enabled]', __( 'Yes', 'ipt_fsqm' ), __( 'No', 'ipt_fsqm' ), $op['enabled'], '1', false, true, array(
					'condid' => 'ipt_fsqm_formhandler_url_wrap,ipt_fsqm_formhandler_method_wrap,ipt_fsqm_formhandler_metatitle_wrap,ipt_fsqm_formhandler_metaarray_wrap,ipt_fsqm_formhandler_meta_wrap,ipt_fsqm_formhandler_resend_on_update_wrap',
				) ); ?>
			</td>
			<td>
