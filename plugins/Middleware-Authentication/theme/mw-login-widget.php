...
if ( ! empty( $user_name ) && ! empty( $welcome ) && ! empty( $logout_link ) ) {
	?>
	<div class="tfs-mw-wrapper-block">
		...
		<ul>
			...
			if ( ! empty( $welcome ) ) {
				?>
				<li><?php echo $welcome; ?>, <span class="user_name"><?php echo $user_name; ?></li>
				<?php
			}

			if ( ! empty( $logout_link ) ) {
				?>
				<li><a href="<?php echo wp_logout_url(); ?>" title="Logout"><?php echo $logout_link; ?></a></li>
				<?php
			}
			?>
		</ul>
