...
class PAKB_Loop {
	...
	public function the_breadcrumbs() {
		...
		echo "<ul class=\"uk-margin-medium-bottom uk-breadcrumb pakb-link pakb-secondary-color\">";
	...
	public function get_category_desc() {
		if ( $this->is_category() ) {
			...
			if($queried_object->description != ''){
				echo '<div class="uk-margin-medium-bottom pakb-secondary-color pakb-category-decs pakb-link">' . $queried_object->description . '</div>';
			}
		}
	}
