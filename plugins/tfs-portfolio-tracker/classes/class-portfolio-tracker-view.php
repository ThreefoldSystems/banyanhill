 ...
 * View Framework
 *
 * A simple class to load and display view files. Almost like part of a really dumbed-down MVC framework
 *
 */
class Portfolio_Tracker_View {
    /**
    ...
    public function __construct(){
        ...
        $this->template_path[] = get_template_directory() . '/portfolio-tracker-theme/templates';
        $this->template_path[] = get_template_directory();
        $this->template_path[] = get_stylesheet_directory() . '/portfolio-tracker-theme/templates';
    }
    /**
