...
<table id="tfs-portfolio-table" class="display compact" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <th class="portfolio-recommendation portfolio-right-align">Allocation %</th>
        <th class="portfolio-stop-loss portfolio-right-align">Stop Loss</th>
    ...
    foreach($content['portfolios'] as $portfolio) :
        if ( !empty($portfolio->PositionSetting->Published) && $portfolio->PositionSetting->Published === true &&
            ...
            <tr>
                ...
                <td class="portfolio-buy-price portfolio-right-align">
                ...
                <td class="portfolio-recommendation portfolio-right-align">
                    <?php echo $portfolio->PositionSetting->Text2; ?>
                </td>
                <td class="portfolio-stop-loss portfolio-right-align">
                    <?php echo isset($portfolio->StopPrice) ?
                        $portfolio->CurrencySygn . number_format($portfolio->StopPrice, 2, '.', '') : ''; ?>
                </td>
