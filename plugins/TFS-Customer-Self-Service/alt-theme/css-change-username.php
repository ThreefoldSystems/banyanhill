...
<div class="tfs_css_content_area">
    ...
    if ( !empty($username_change_time_remaining) ) {
        ...
        <form id="tfs_css_change_username_form">
            <p>
                <strong><?php echo tfs_css()->core->get_language_variable('txt_css_actual_username'); ?>:</strong>
                <span class="username_wrap"><?php echo $customer_username; ?></span>
            </p>
            ...
            <div class="text-right">
                <?php
                if ( $request_pwd_on_username_update ) {
                    ?>
