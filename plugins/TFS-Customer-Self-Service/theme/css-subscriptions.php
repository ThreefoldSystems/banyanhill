                    ...
                    <article>
                        ...
                        <ul class='tfs_css_subs_ul tfs_csd_container__ul'>
							...
							if( defined('CSD_CC_INFO')) {
								if ( $subscriptions_info[ $item->pubcode ][ 'cc_info' ] ) {
									?>
									<li class="li-arrow tfs_csd_container__ul__li--subs payment-tab-desc">
										<strong>Credit Card Details</strong>&nbsp;

										<br><span class="input-blured"><?php echo $subscriptions_info[
											   		$item->pubcode ][ 'cc_info' ];?></span>

										<div class="arrow">
											<a target="_blank"
                                               href="<?php echo $subscriptions_info[$item->pubcode ][ 'renewal_link' ]; ?>">
												Update
											</a>
										</div>
									</li><br/>
