				...
				$paginated.each(function () {
					...
					$pagination.on('click', 'a', function (e) {
						...
						if (page_is_loaded) {
							...
							$this.parents('.et_pb_extra_column_main').find('.paginated_content article:visible').each(function() {
								et_displayed_ids.push(jQuery(this).attr('id').replace('post-', ''));
							});								
							...
							$.ajax({
								...
								data: {
									...
									tax_query: tax_query,
									// JW Fix 6/27/2018
									et_displayed_ids: et_displayed_ids										
								},
