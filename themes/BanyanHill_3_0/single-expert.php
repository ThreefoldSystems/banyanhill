<?php 
	wp_enqueue_style( 'experts', get_stylesheet_directory_uri() . '/css/experts.css' );
					...
					<span xmlns:v="http://rdf.data-vocabulary.org/#">
						<span typeof="v:Breadcrumb"><a href="<?php echo '//' . $_SERVER['HTTP_HOST']; ?>" rel="v:url" property="v:title">Home</a> » 
							<span rel="v:child" typeof="v:Breadcrumb">
								<a href="/meet-our-experts/" rel="v:url" property="v:title">Meet Our Experts</a> » 
