...
// 		add_image_size( 'dw-bh-expert-sidebar', 68 , 90, true );
// 	}
...
//	}
	...
	function add_social_profile() {
		...
		if (!array_key_exists( $payload['network'], (array) $current_data ) ) {
			$current_data[$payload['network']] = sanitize_text_field($payload['url']);
