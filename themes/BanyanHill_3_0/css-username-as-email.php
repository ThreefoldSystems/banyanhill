...
<div style="display: none">
	<div class="tfs_css_change_email_address_container">
		...
		<input type='email' value='<?php echo $customer_username; ?>' required name='new_email' id='new_email' style='display: none'>
		<input type='email' value='<?php echo $customer_username; ?>' required  name='new_email_repeat' style='display: none'>
		<input name='actual_url' id='actual_url' type='hidden' value='<?php echo $url; ?>'>
		<?php
